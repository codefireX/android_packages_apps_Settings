...
public class RebootReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_REBOOT = "com.android.settings.codefire.ACTION_DAILY_REBOOT";
    public static final String ACTION_WARN = "com.android.settings.codefire.ACTION_DAILY_REBOOT_WARNING";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_REBOOT.equals(action)) {
            Log.i("CF", "CodeFire daily reboot starting!");
